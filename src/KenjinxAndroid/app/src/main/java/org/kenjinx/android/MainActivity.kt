...
class MainActivity: BaseActivity() {
    ...
    private val displayListener = object: DisplayManager.DisplayListener {
        ...
        override fun onDisplayChanged(displayId: Int) {
            ...
            try {
                KenjinxNative.setSurfaceRotationByAndroidRotation(rot)
            } catch(_: Throwable) {
            }
    ...
    private fun doOrientationPulse(currentRot: Int) {
        ...
        handler.post {
            if(isGameRunning) {
                ...
                try {
                    mainViewModel?.gameHost?.onOrientationOrSizeChanged(currentRot)
                } catch(_: Throwable) {
                }
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("EhangTest", "MainActivity onCreate")
        ...
        mainViewModel?.gamepadManager = GamepadManager(this)
    ...
    override fun onResume() {
        ...
        isActive = true
        mainViewModel?.gamepadManager?.startListening()
        if(isGameRunning && QuickSettings(this).enableMotion) {
            if(QuickSettings(this).useControllerSensor) {
    ...
    override fun onPause() {
        ...
        mainViewModel?.gamepadManager?.stopListening()
    }
